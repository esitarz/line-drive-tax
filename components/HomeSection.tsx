...
export const HomeSection = ({ frontmatter, onVisible }: HomeSectionProps) => {
  ...
  return (
    <section
      id="home"
      ref={sectionRef}
      className="min-h-screen snap-start flex flex-col items-center justify-center p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]"
    >
      <motion.div
      ...
      >
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <a
            className="flex items-center border border-transparent transition-colors bg-secondary text-white hover:text-secondary rounded-md hover:bg-accent dark:hover:bg-secondary-300 font-medium text-lg h-10 sm:h-12 px-4 sm:px-8 sm:w-auto"
            href="#contact"
            onClick={(e) => {
              e.preventDefault();
